...
function main() {
    ...
    const entrada3 = parseFloat(prompt("Digite a terceira entrada: "));
...
Digite a função desejada: `));
    ...
    let resultado;
    if (opc === 1) {
        resultado = limite_rapido(entrada1 * peso1 + entrada2 * peso2 + entrada3 * peso3);
    } else if (opc === 2) {
        resultado = funcao_rampa(entrada1 * peso1 + entrada2 * peso2 + entrada3 * peso3);
    } else if (opc === 3) {
        resultado = funcao_sigmoide(entrada1 * peso1 + entrada2 * peso2 + entrada3 * peso3);
    } else {
