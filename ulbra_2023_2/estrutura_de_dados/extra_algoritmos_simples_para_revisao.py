...
# soma = n1 + n2 + n3 + n4
# print(f"O resultado de {n1} + {n2} + {n3} + {n4} e: {soma}")
...
# print(f"A media ponderada e: {media}")

# 4 Faça um programa que receba o salário de um funcionário, calcule e mostre o novo salário, sabendo-se que este sofreu um aumento de 25%.
# salario_antigo = int(input("Digite seu salario: "))
# salario_novo = salario_antigo * 0.25
# print (f"Seu novo salario e de: {salario_antigo + salario_novo}")
...
# print(f"O seu salario teve um aumento de {perc}% ({aumento} reais) e seu novo salario agora e de: {salario_novo}")
